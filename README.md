<html>
    ...
    <body>
        ...
        <div>
            <p>
                <img src="img\accueil\bienvenue.jpg" class="img-taille" style="block-size: 700px; inline-size: 1250px;margin: inline start 10px;"">
            </p>
        </div>
        <!--fin portfolio-->
        <!--debut presentation-->
                         ...
                         Poumon économique de l'archipel japonais, Tokyo n'en oublie pas d'offrir une variété de paysages hallucinante à quelques encablures
                          et dans toutes les directions : de la mer à la montagne, de la randonnée à l'infinité bétonnée,
                           de sa modernité la plus vaste à (parfois aussi) sa vétusté délicieuse.</h3>
                            <img src="img/tokyo/tokyo-image.jpeg" class="img-taille" style="block-size: 600px; inline-size: 1250px;margin: inline start 10px;">
                        </p>
                </div>
            </div>
            <div>
